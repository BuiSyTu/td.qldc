	...
	<div class="m-portlet mb-0">
		...
		<div class="m-portlet__body">
			...
			<script id="action-template" type="text/x-handlebars-template">
				<a href="javascript:void(0)" view-nhankhau data-id="{{SoHoKhau}}"
					class="m-portlet__nav-link btn m-btn m-btn--hover-info m-btn--icon m-btn--icon-only m-btn--pill"
					data-toggle="m-tooltip" title="Xem thông tin nhân khẩu">
...
<asp:Content runat="server" ContentPlaceHolderID="PlaceHolderPageScripts">
	<script type="text/javascript" src="danh-sach-nhan-khau.js"> </script>
</asp:Content>
