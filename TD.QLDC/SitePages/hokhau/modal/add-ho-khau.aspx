		...
		<div id="form" tdf-type="form" class="m-form m-form--fit">
			...
			<div class="form-group m-form__group row">
				...
				<select
					...
					tdf-type="select"
					data-width="100%"
					data-placeholder="Chọn loại hộ gia đình"
					data-ajax-url="/qldcapi/categories?active=true&nhomid=11"
			...
			<div class="form-group m-form__group row">
				...
				<select
					...
					tdf-type="select"
					data-width="100%"
					data-placeholder="Chọn thôn"
					data-ajax-url="/qldcapi/areas?type=7"
					...
					data-val="true"
					data-allow-clear="true"
					onchange="ChooseArea('MaThon', 'MaXom')">
					<option value=""></option>
				</select>
			</div>
			<div class="form-group m-form__group row">
				...
				<select
					...
					tdf-type="select"
					data-width="100%"
					data-placeholder="Chọn xóm"
					data-ajax-url="/qldcapi/areas?type=9"
					data-ajax-page-size=-1
					data-item-url="/qldcapi/areas/code/{id}"
					data-item-result-field="result"
					data-result-field=result
			...
			<div class="form-group m-form__group row">
				...
				<textarea type="text" tdf-type="textarea" rows="3" data-maxlength-threshold="10" maxlength="1000"
					name="GhiChu" data-maxlength-warning-class="m-badge m-badge--primary m-badge--rounded m-badge--wide"
			...
			(function (factor) {
				...
				(function ($, modals, forms, toastr) {
					...
					var loadData = function (id) {
						...
						// set id cho input#ID
						$('[name=ID]').val(id);
						var hoKhauService = new td.qldc.HoKhaus();
